...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.userLogin = function (userInfo, response) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.authService.userLogin(userInfo)];
                        case 1:
                            loginInfo = _a.sent();
                        ...
                        case 2:
                            e_1 = _a.sent();
                            response.status(401).json(e_1.message);
                            return [3 /*break*/, 3];
        ...
        AuthController_1.prototype.adminLogin = function (userInfo, response) {
            return __awaiter(this, void 0, void 0, function () {
                var loginInfo, e_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.authService.adminLogin(userInfo)];
                        case 1:
                            loginInfo = _a.sent();
                            response.cookie('refreshToken', loginInfo.tokens.refreshToken, { httpOnly: true });
                            return [2 /*return*/, response.status(common_1.HttpStatus.OK).json({
                        ...
                        case 2:
                            e_2 = _a.sent();
                            response.status(401).json(e_2.message);
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/];
                    }
                });
        ...
        AuthController_1.prototype.logout = function (email, response) {
            return __awaiter(this, void 0, void 0, function () {
                var e_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.authService.logoutFunction(email)];
                        case 1:
                            _a.sent();
                            response.clearCookie('refreshToken');
                            return [2 /*return*/, response.status(common_1.HttpStatus.OK).json('Успешный выход')];
                        case 2:
                            e_3 = _a.sent();
        ...
        AuthController_1.prototype.refreshToken = function (email, response, request) {
            return __awaiter(this, void 0, void 0, function () {
                var refreshToken, userWithTokens, e_4;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            ...
                            return [4 /*yield*/, this.authService.refreshTokens(email, refreshToken)];
                        case 1:
                            userWithTokens = _a.sent();
                            response.cookie('refreshToken', userWithTokens.refreshToken, { httpOnly: true });
                            delete userWithTokens.refreshToken;
                            return [2 /*return*/, response.status(common_1.HttpStatus.OK).json(__assign({}, userWithTokens))];
                        case 2:
                            e_4 = _a.sent();
                            response.status(401).json(e_4.message);
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/];
                    }
                });
    ...
    (function () {
        ...
        _userLogin_decorators = [(0, common_1.Put)('user-login')];
        _adminLogin_decorators = [(0, common_1.Put)('admin-login')];
        _logout_decorators = [(0, common_1.Put)('logout')];
        _refreshToken_decorators = [(0, common_1.Put)('refresh')];
        __esDecorate(_classThis, null, _userLogin_decorators, { kind: "method", name: "userLogin", static: false, private: false, access: { has: function (obj) { return "userLogin" in obj; }, get: function (obj) { return obj.userLogin; } }, metadata: _metadata }, null, _instanceExtraInitializers);
