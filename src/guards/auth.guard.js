...
var AuthGuard = function () {
    ...
    var AuthGuard = _classThis = /** @class */ (function () {
        function AuthGuard_1(tokenService, reflector) {
        ...
        AuthGuard_1.prototype.canActivate = function (context) {
            ...
            var role = this.reflector.getAllAndOverride(roles_decorator_1.Roles, [context.getHandler(), context.getClass()]);
            if (!header) {
        ...
        AuthGuard_1.prototype.isAuthenticated = function (token, role) {
            var verifyToken = this.tokenService.verifyToken(token);
            if (!verifyToken) {
                throw new common_1.UnauthorizedException();
            }
